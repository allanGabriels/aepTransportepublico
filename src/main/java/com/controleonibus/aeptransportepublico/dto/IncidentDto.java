...
public record IncidentDto(
                ...
                @NotNull(message = "O ID da viagem (tripId) não pode ser nulo") Long tripId,

                @NotNull(message = "O ID do fiscal (fiscalId) não pode ser nulo") Long fiscalId,

                @NotNull(message = "O ID do tipo de incidente (incidentType) não pode ser nulo") Long incidentType,
